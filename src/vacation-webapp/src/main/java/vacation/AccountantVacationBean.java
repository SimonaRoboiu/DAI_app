...
@Named
@RequestScoped
public class AccountantVacationBean implements Serializable {
	...
	private List<RequestedPto> pendingRequests;
	private List<RequestedPto> approvedPendingRequests;
...
//				FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get("employeeId"));
		...
		approvedPendingRequests = new ArrayList<>();
	}
	...
	public List<RequestedPto> getApprovedPendingRequests() {
		return approvedPendingRequests;
	}

	public void setApprovedPendingRequests(List<RequestedPto> approvedPendingRequests) {
		this.approvedPendingRequests = approvedPendingRequests;
	}

	public List<RequestedPto> getPendingRequests() {
		return pendingRequests;
	}

	public void setPendingRequests(List<RequestedPto> pendingRequests) {
	...
	public void getPendingRequestsForAccountant() {
		pendingRequests = persistDataEJB.getPendingRequests(userSessionBean.getCurrentUser().getEmployee().getEmployeeId());
	}
	
	public void approveRequests() {
			
		//persistDataEJB.approveRequests(approvedPendingRequests);
	}
}
